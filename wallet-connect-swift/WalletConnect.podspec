Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/nordicenergy/Wallet/wallet-connect-swift'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hewigovens' => '360470+hewigovens@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/nordicenergy/Wallet/WalletConnect.git', :tag => s.version.to_s }
